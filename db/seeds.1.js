...
db.once("open", async function() {
  ...
  // Pull in Models from the `schema.js`
   ...
   CardModel.collection.insertMany([getCard("Black Lotus")], function(err,r) {
    ...
    // await cardCollection.map( (card) => {
    //   console.log("error 4")
    //   let cardToInput = [getCard(card)]
    //   console.log("error 5")
    //   console.log(cardToInput)
    //   CardModel.collection.insertMany(cardToInput, function(err,r) {
    //     assert.equal(null, err);
    //     assert.equal(1, r.insertedCount);
    //     db.close();
    //   });
